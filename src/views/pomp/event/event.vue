    ...
    <div class="event-list" v-loading="loading" element-loading-text="加载中……">
        ...
        <div class="table-box">
            ...
            <el-table :data="tableData" style="width: 100%" border class="tran-table no-col-title" :resizable="false">
                <el-table-column :min-width="50" prop="eventState" label="项目来源" header-align="left" align="left"></el-table-column>
                ...
                <el-table-column label="操作" :min-width="120" align="center">
                    <template scope="scope">
                        ...
                        <el-button type="text" size="small" disable="disable">|</el-button>
                        <el-button type="text" size="small" @click="dialogFormVisible = true">转正式</el-button>
                        <el-button type="text" size="small" disable="disable">|</el-button>
...
//                let _this= this;
//                console.log("******执行前");
//                _this.$http.post("http://localhost:3000/apis/getShiYong",{}).then((response)=>{
...
//                });
                $.ajax({
                    type:"post",
                    async:false,
                    url:"http://localhost:3000/apis/getShiYong",
                    dataType:"json",
